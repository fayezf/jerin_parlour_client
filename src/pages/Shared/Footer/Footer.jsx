        ...
        <div>
            <footer className="footer p-10 bg-[#F63E7B] text-base-content">
                ...
                <div className='text-white'>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br /> Culpa temporibus quos ducimus animi maiores <br /> ipsum sequi veritatis, reprehenderit nam assumenda.</p>
